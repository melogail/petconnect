...
const commentsCount = ref(props.pet?.commentsCount || 0);
const showComments = ref(false);
const spayedNeutered = computed(function () {
...
onMounted(() => {
    ...
    document.addEventListener(
        'keydown',
        (e) => e.key === 'Escape' && (isShareOpen.value = false),
    );
});
...
<template>
    ...
    >
        ...
        >
            ...
            <div
                class="absolute inset-0 z-[1] bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 transition-opacity duration-500 ease-in-out group-hover:opacity-100"
            ></div>
            <div class="h-full w-full overflow-hidden">
                <img
                    ...
                    :style="{
                        'view-transition-name': `pet-image-${pet.id || 'default'}`,
                    }"
                />
            </div>
            ...
            >
                <div class="relative">
                    ...
                    <div
                        class="absolute -inset-1 animate-pulse rounded-full opacity-75 blur transition-all duration-500 group-hover:animate-none group-hover:opacity-100"
                        :class="{
                    ...
                    <!-- Main badge -->
                    <div
                        class="relative flex items-center rounded-full px-3 py-1 text-xs font-bold text-white shadow-lg transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl"
                        :class="{
                            'bg-gradient-to-r from-amber-400 to-rose-500 shadow-amber-500/30 group-hover:shadow-amber-500/40':
                                pet.status === 'sale',
                            'bg-gradient-to-r from-teal-400 to-emerald-500 shadow-teal-500/30 group-hover:shadow-teal-500/40':
                                pet.status === 'adoption',
                        }"
                    >
                ...
                <TooltipProvider>
                    <div class="flex items-center justify-center gap-3">
                        ...
                        <Tooltip v-if="pet.vaccinated">
                            <TooltipTrigger
                                class="flex h-8 w-8 items-center justify-center rounded-full bg-white/90 p-1.5 text-green-600 shadow-sm backdrop-blur-sm transition-all duration-200 hover:scale-110 hover:bg-white"
                            >
                        ...
                        <!-- Serialized -->
                        <Tooltip v-if="pet.spayedNeutered">
                            <TooltipTrigger
                                class="flex h-8 w-8 items-center justify-center rounded-full bg-white/90 p-1.5 text-blue-600 shadow-sm backdrop-blur-sm transition-all duration-200 hover:scale-110 hover:bg-white"
                            >
                        ...
                        <Tooltip>
                            <TooltipTrigger
                                class="flex h-8 w-8 items-center justify-center rounded-full bg-white/90 p-1.5 text-amber-600 shadow-sm backdrop-blur-sm transition-all duration-200 hover:scale-110 hover:bg-white"
                            >
                                <svg
                                    class="h-4 w-4"
                                    fill="none"
                        ...
                        <Tooltip>
                            <TooltipTrigger
                                class="flex h-8 w-8 items-center justify-center rounded-full bg-white/90 p-1.5 text-purple-600 shadow-sm backdrop-blur-sm transition-all duration-200 hover:scale-110 hover:bg-white"
                            >
                                <svg
                                    class="h-4 w-4"
                                    fill="none"
        ...
        <div
            class="p-5 pt-4 transition-all duration-300 group-hover:bg-white/95 dark:group-hover:bg-gray-800/95"
        >
            ...
            <!-- Breed and Age -->
            <div
                class="mb-3 flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400"
            >
            ...
            <div class="relative mb-4">
                <div class="relative overflow-hidden">
                    <p
                        class="text-sm leading-relaxed text-gray-700 transition-all duration-500 ease-in-out dark:text-gray-300"
                        :class="
                            showFullDescription
                                ? 'max-h-[500px]'
            ...
            <div class="relative my-4">
                ...
                <div class="relative flex justify-center">
                    <span
                        class="bg-white px-2 text-xs text-gray-400 dark:bg-gray-800 dark:text-gray-500"
                    >
                        <svg
                            class="h-4 w-4"
                            fill="none"
            ...
            <!-- Action Buttons -->
            <div
                class="mb-4 flex items-center justify-between text-gray-500 dark:text-gray-400"
            >
                ...
                <div class="group relative">
                    ...
                    <div
                        class="absolute -bottom-1 left-1/2 h-0.5 w-0 -translate-x-1/2 bg-primary-500 transition-all duration-300 group-hover:w-4/5"
                    ></div>
                </div>
                                ...
                                <Tooltip>
                                    <TooltipTrigger>
                                        <button
                                            ...
                                            class="text-[#1877F2] transition-transform hover:scale-110"
                                        >
                                            <svg
                                                class="h-5 w-5"
                                                fill="currentColor"
                                ...
                                <Tooltip>
                                    <TooltipTrigger>
                                        <button
                                            ...
                                            class="text-[#25D366] transition-transform hover:scale-110"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24"
                                ...
                                <Tooltip>
                                    <TooltipTrigger>
                                        <button
                                            ...
                                            class="text-gray-500 transition-transform hover:scale-110"
                                        >
                                            <Copy class="h-5 w-5" />
                                        </button>
                                    </TooltipTrigger>
