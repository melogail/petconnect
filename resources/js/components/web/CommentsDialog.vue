<template>
    <Dialog>
        <DialogTrigger as-child>
            <button
                class="group flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm transition-colors hover:bg-gray-100 hover:text-blue-500 dark:hover:bg-gray-700"
            >
                <MessageSquare
                    class="h-5 w-5 group-hover:fill-blue-500 group-hover:text-blue-500"
                />
            ...
            >
                <div class="flex gap-2">
                    ...
                    <Button
                        ...
                        :class="{
                            'cursor-not-allowed opacity-75': !newComment.trim(),
                        }"
                    >
                        <span>Comment</span>
                    </Button>
...
const comments = ref([
        ...
        replies: [
            {
                id: 101,
                content:
                    'Thank you! Max is about 2 years old according to the shelter records.',
                        ...
                        replies: [
                            {
                                id: 10001,
                                content:
                                    'Yes, he was neutered before we got him from the shelter.',
                                created_at: new Date(
                                    Date.now() - 2900000,
                                ).toISOString(),
                                user: {
            ...
            },
            {
                id: 102,
                content:
                    'He looks so playful! Does he get along well with other dogs?',
            ...
            },
            {
                id: 103,
                content:
                    "Yes, he's great with other dogs! We have regular playdates at the local dog park.",
                ...
                replies: [
                    {
                        id: 1002,
                        content:
                            "That's great to hear! What days do you usually go to the park?",
        ...
        replies: [
            {
                id: 201,
                content:
                    'Max is a Golden Retriever mix! The shelter thinks he might have some Border Collie in him too.',
                ...
                replies: [
                    {
                        id: 2001,
                        content:
                            'I thought I saw some Border Collie in him! That explains his energy levels.',
                        created_at: new Date(
                            Date.now() - 82000000,
                        ).toISOString(),
                        user: {
            ...
            },
            {
                id: 202,
                content:
                    'That explains his beautiful golden coat and those intelligent eyes!',
    ...
    },
    {
        ...
        content:
            "Is Max house-trained? Looking for a dog that's already trained.",
        ...
        replies: [
            {
                id: 301,
                content:
                    'Yes, Max is fully house-trained! He also knows basic commands like sit, stay, and paw.',
                ...
                replies: [
                    {
                        id: 3001,
                        content:
                            "That's impressive! How long did it take to train him?",
                        created_at: new Date(
                            Date.now() - 165000000,
                        ).toISOString(),
                        user: {
                        ...
                        replies: [
                            {
                                id: 30001,
                                content:
                                    "He came to us knowing the basics, but we've been working on more advanced commands for about 3 months now.",
                                created_at: new Date(
                                    Date.now() - 164900000,
                                ).toISOString(),
                                user: {
            ...
            },
            {
                id: 303,
                content:
                    "He gets along well with cats! We have a resident cat and they're best friends.",
